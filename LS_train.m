...
while epoch < max_epochs
    ...
    for iter = 1:n
        ...
        elseif strcmp(opt_method,'saga') % to be completed
            if epoch == 1 && iter == 1
                for i_num  = 1:n
                    gradient = compute_gradient(w,X(:,index),Y(index),C);
        ...
        elseif strcmp(opt_method,'sdca') % to be completed
